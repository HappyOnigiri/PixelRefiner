...
export const REPORT_TRANSLATIONS = {
	en: {
		...
		candidateSuggestion: "Candidate list",
		candidateSuggestionWouldShow: "expected to show",
		candidateSuggestionWouldNotShow: "not expected to show",
		candidateSuggestionNotApplicable: "not applicable",
		warningPresentation: "WARNING presentation",
		warningPresentationCandidateList: "candidate list",
		warningPresentationIndicator: "warning indicator",
		warningPresentationNone: "none",
		candidateSuggestionReason: "Decision reason",
		...
		candidateKinds: {
			...
			"cell-scale": "Pixel size",
			preserve: "Keep original size",
			convert: "Convert option",
		},
		candidateCellScales: {
			quarter: "Much smaller pixels (1/4x)",
			half: "Smaller pixels (1/2x)",
			same: "Detected pixel size (1x)",
			double: "Larger pixels (2x)",
			quadruple: "Much larger pixels (4x)",
		},
	},
	ja: {
		title: "品質レポート",
		...
		warningTrigger: "判定条件",
		candidateDiagnostics: "Auto候補リスト診断",
		candidateSuggestion: "候補リスト",
		candidateSuggestionWouldShow: "表示される想定",
		candidateSuggestionWouldNotShow: "表示されない",
		candidateSuggestionNotApplicable: "対象外",
		warningPresentation: "WARNINGの表示先",
		warningPresentationCandidateList: "候補リスト",
		warningPresentationIndicator: "警告アイコン",
		warningPresentationNone: "なし",
		candidateSuggestionReason: "判定理由",
		...
		candidateCellScales: {
			quarter: "ドットをとても小さく（1/4倍）",
			half: "ドットを小さく（1/2倍）",
			same: "検出したドットのまま（1倍）",
			double: "ドットを大きく（2倍）",
			quadruple: "ドットをとても大きく（4倍）",
		},
	},
	"zh-CN": {
		...
		candidateSuggestionNotApplicable: "不适用",
		warningPresentation: "WARNING 显示位置",
		warningPresentationCandidateList: "候选列表",
		warningPresentationIndicator: "警告图标",
		warningPresentationNone: "无",
		candidateSuggestionReason: "判定原因",
