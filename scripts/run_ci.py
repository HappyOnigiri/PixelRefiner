...
def main():
    ...
    check_tasks = [
        ...
        ("Dead Code", ["make", "check-dead-code"], False),
        ("Unused Class Members", ["make", "check-unused-members"], False),
        ("Code Duplication", ["make", "check-duplicates"], False),
        ("Empty Blocks", ["make", "check-empty-blocks"], False),
