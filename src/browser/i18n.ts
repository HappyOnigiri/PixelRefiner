...
const resources = {
	ja: {
		...
		"preset.retro_game": "レトロゲーム風",
		"preset.background_art": "背景用の一枚絵",
		"preset.illustration_to_pixel_art": "イラストをドット絵に変換",
		...
		"guide.recipe1.settings":
			"「プリセット」を「おまかせ」のままにします（背景は自動で透過されます）。",
	...
	"zh-CN": {
		...
		"preset.retro_game": "复古游戏风格",
		"preset.background_art": "背景插画",
		"preset.illustration_to_pixel_art": "将插画转换为像素画",
	...
	en: {
		...
		"preset.retro_game": "Retro Game Style",
		"preset.background_art": "Background Artwork",
		"preset.illustration_to_pixel_art": "Convert Illustration to Pixel Art",
